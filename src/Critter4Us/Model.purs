...
type Model = { animals :: Map Animal.Id Animal }

initialModel :: Model
initialModel = { animals: Map.singleton startingAnimal.id startingAnimal }
  where
  startingAnimal = Animal.named "Genesis" 3838 # Animal.addTag "mare"

addAnimalTag :: Animal.Id -> String -> Model -> Model
addAnimalTag id tag = over (_oneAnimal id) (map $ Animal.addTag tag)
